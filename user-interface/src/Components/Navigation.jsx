...
<div className='' >
          ...
          <NavLink  to="/chat" className="flex items-center  hover:rounded-full  hover:ml-6  gap-2 py-3">
            <RiChatSmile3Line className="w-8 h-8"/>
            CHATS
            </NavLink>

          <NavLink  to="/notification" className="flex items-center   hover:rounded-full  hover:ml-6  gap-2 py-3">
